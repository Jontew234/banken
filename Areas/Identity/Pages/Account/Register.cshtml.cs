...
namespace Platinum.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.PhoneNumber = Input.PhonenNumber;
                ...
                {
                    // min modifiering
                    bool exists = await _roleManager.RoleExistsAsync("Dräng");
                    if (exists)
                    {
                        await _userManager.AddToRoleAsync(user, "Dräng");
                    }
